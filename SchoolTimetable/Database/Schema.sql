...
-- Script date 2025. 05. 03. 21:32:40
-- Target Server: SQL Server
-- Server Version: 2022

-- 
-- Creating a table BellSchedules 
-- 
CREATE TABLE BellSchedules (
   ...
   CONSTRAINT PK_BellSchedules PRIMARY KEY (Id),
   CONSTRAINT KEY_BellSchedules_LessonNum UNIQUE (LessonNum)
)
GO
...
CREATE TABLE LoggedLessons (
   ...
   CONSTRAINT FK_LoggedLessons_BellSchedules_4 FOREIGN KEY (LessonNum) REFERENCES BellSchedules (LessonNum) ON DELETE NO ACTION
)
GO
...
CREATE TABLE TimetableLessons (
   ...
   CONSTRAINT FK_TimetableLessons_BellSchedules_1 FOREIGN KEY (LessonNum) REFERENCES BellSchedules (LessonNum) ON DELETE NO ACTION,
