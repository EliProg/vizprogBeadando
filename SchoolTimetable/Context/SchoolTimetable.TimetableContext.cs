...
namespace cnTimetable
{
    ...
    public partial class TimetableContext : DbContext
    {
        ...
        private void enEventMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<enEvent>().Property(x => x.UserId).HasColumnName(@"UserId").ValueGeneratedNever();
            modelBuilder.Entity<enEvent>().Property(x => x.Type).HasColumnName(@"Type").IsRequired().ValueGeneratedNever().HasMaxLength(50);
            modelBuilder.Entity<enEvent>().Property(x => x.Param1).HasColumnName(@"Param1").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<enEvent>().Property(x => x.Param2).HasColumnName(@"Param2").ValueGeneratedNever().HasMaxLength(255);
        ...
        private void RelationshipsMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<enUser>().HasMany(x => x.enEvents).WithOne(op => op.enUser).HasForeignKey(@"UserId").IsRequired(false);
            ...
            modelBuilder.Entity<enEvent>().HasOne(x => x.enUser).WithMany(op => op.enEvents).HasForeignKey(@"UserId").IsRequired(false);
