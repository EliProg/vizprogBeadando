...
// Code is generated on: 2025. 04. 15. 11:42:38
//
...
namespace cnTimetable
{
    ...
    public partial class TimetableContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(@"Data Source=(localdb)\mssqllocaldb;Initial Catalog=VizProgDB;Integrated Security=True;TrustServerCertificate=True;");
            }
        ...
        private void enEventMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<enEvent>().Property(x => x.Description).HasColumnName(@"Description").IsRequired().ValueGeneratedNever().HasMaxLength(200);
        ...
        {
            modelBuilder.Entity<enUser>().HasMany(x => x.enLoggedLesson).WithOne(op => op.enUser).HasForeignKey(@"TeacherId").IsRequired(true);
            modelBuilder.Entity<enUser>().HasMany(x => x.enTimetableLesson).WithOne(op => op.enUser).HasForeignKey(@"TeacherId").IsRequired(true);
            ...
            modelBuilder.Entity<enLoggedLesson>().HasOne(x => x.enSubject).WithMany().HasForeignKey(@"SubjectId").IsRequired(true);
            modelBuilder.Entity<enLoggedLesson>().HasOne(x => x.enUser).WithMany(op => op.enLoggedLesson).HasForeignKey(@"TeacherId").IsRequired(true);
            modelBuilder.Entity<enLoggedLesson>().HasOne(x => x.enClass).WithMany().HasForeignKey(@"ClassId").IsRequired(true);
            modelBuilder.Entity<enLoggedLesson>().HasOne(x => x.enSchoolYear).WithMany().HasForeignKey(@"SchoolYearId").IsRequired(true);
            ...
            modelBuilder.Entity<enTimetableLesson>().HasOne(x => x.enUser).WithMany(op => op.enTimetableLesson).HasForeignKey(@"TeacherId").IsRequired(true);
